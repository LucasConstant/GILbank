  ...
  for (let batch = first_batch; batch !== null; batch = __privateGet(batch, _next)) {
    ...
    if (others.length === 0) {
      ...
      if (__privateGet(batch, _scheduled).length > 0 && !__privateGet(batch, _decrement_queued)) {
        batch.apply();
        for (var root of __privateMethod(_a2 = batch, _Batch_instances, resolve_fn).call(_a2)) {
  ...
  return new Proxy(
    ...
    value,
    {
      ...
      getOwnPropertyDescriptor(target, prop) {
        var _a2;
        (_a2 = this.has) == null ? void 0 : _a2.call(this, target, prop);
...
//# sourceMappingURL=chunk-7MJ7SC3I.js.map
